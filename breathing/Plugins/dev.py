...
@Obanai.on_message(command(["adddev", "rmdev"]))

async def add_dev(c: Obanai, m:Message):
...
@Obanai.on_message(command("ping", sudo_cmd=True))
...
@Obanai.on_message(command("logs", dev_cmd=True))

async def send_log(c: Obanai, m: Message):
...
@Obanai.on_message(command("neofetch", dev_cmd=True))
...
@Obanai.on_message(command(["eval", "py"], dev_cmd=True))

async def evaluate_code(c: Obanai, m: Message):
    ...
    for i in evaluation.split(None):
        ...
        if (
            ...
            evaluation = "Lmao what do you need"
...
@Obanai.on_message(command(["restart", "update"], owner_cmd=True))

async def restart_the_bot(c:Obanai,m:Message):
...
@Obanai.on_message(command("chatlist", dev_cmd=True))

async def chats(c: Obanai, m: Message):
...
@Obanai.on_message(command("uptime", dev_cmd=True))
...
@Obanai.on_message(command("leavechat", dev_cmd=True))

async def leave_chat(c: Obanai, m: Message):
...
@Obanai.on_message(command("chatbroadcast", dev_cmd=True))
