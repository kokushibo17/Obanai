...
@Obanai.on_message(command("save") & admin_filter & ~filters.bot)
...
async def get_note_func(c: Obanai, m: Message, note_name, priv_notes_status):
...
@Obanai.on_message(filters.regex(r"^#[^\s]+") & filters.group & ~filters.bot)

async def hash_get(c: Obanai, m: Message):
...
@Obanai.on_message(command("get") & filters.group & ~filters.bot)

async def get_note(c: Obanai, m: Message):
...
@Obanai.on_message(command(["privnotes", "privatenotes"]) & admin_filter & ~filters.bot)
...
@Obanai.on_message(command("notes") & filters.group & ~filters.bot)
...
@Obanai.on_message(command("clear") & admin_filter & ~filters.bot)
...
@Obanai.on_message(command("clearall") & owner_filter & ~filters.bot)
...
@Obanai.on_callback_query(filters.regex("^clear_notes$"))
