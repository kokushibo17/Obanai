...
@Obanai.on_message(command(["info", "whois"]))

async def info_func(c: Obanai, message: Message):
...
@Obanai.on_message(command(["chinfo", "chatinfo", "chat_info"]))

async def chat_info_func(c: Obanai, message: Message):
