...
@Obanai.on_message(command("tmute") & restrict_filter)

async def tmute_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("dtmute") & restrict_filter)

async def dtmute_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("stmute") & restrict_filter)

async def stmute_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("smute") & restrict_filter)

async def smute_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("dmute") & restrict_filter)

async def dmute_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("unmute") & restrict_filter)

async def unmute_usr(c: Obanai, m: Message):
...
@Obanai.on_callback_query(regex("^unmute_"))

async def unmutebutton(c: Obanai, q: CallbackQuery):
