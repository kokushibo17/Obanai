...
@Obanai.on_message(command("wiki"))
...
@Obanai.on_message(command("gdpr"))
...
async def id_info(c: Obanai, m: Message):
...
@Obanai.on_message(command("paste"))
