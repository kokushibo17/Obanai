...
@Obanai.on_message(command("disable") & can_change_filter)
...
@Obanai.on_message(command("disabledel") & can_change_filter)
...
@Obanai.on_message(command("enable") & can_change_filter)
...
@Obanai.on_message(command("disableable") & can_change_filter)
...
@Obanai.on_message(command("disabled") & admin_filter)
...
@Obanai.on_message(command("enableall") & owner_filter)
...
@Obanai.on_callback_query(filters.regex("^enableallcmds$"))
