...
@Obanai.on_message(command("cleanwelcome") & admin_filter)
...
@Obanai.on_message(command("cleangoodbye") & admin_filter)
...
@Obanai.on_message(command("cleanservice") & admin_filter)
...
@Obanai.on_message(command("setwelcome") & admin_filter & bot_admin_filter)
...
@Obanai.on_message(command("setgoodbye") & admin_filter & bot_admin_filter)
...
@Obanai.on_message(command("resetgoodbye") & admin_filter & bot_admin_filter)
...
@Obanai.on_message(command("resetwelcome") & admin_filter & bot_admin_filter)
...
@Obanai.on_message(filters.service & filters.group, group=59)
...
@Obanai.on_chat_member_updated(filters.group, group=69)

async def member_has_joined(c: Obanai, member: ChatMemberUpdated):
...
@Obanai.on_chat_member_updated(filters.group, group=99)

async def member_has_left(c: Obanai, member: ChatMemberUpdated):
...
@Obanai.on_message(command("welcome") & admin_filter)

async def welcome(c: Obanai, m: Message):
...
@Obanai.on_message(command("goodbye") & admin_filter)

async def goodbye(c: Obanai, m: Message):
...
× Obanai must be an admin to greet and goodbye users.
