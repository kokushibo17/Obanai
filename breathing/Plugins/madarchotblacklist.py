...
@Obanai.on_message(command("blacklist") & filters.group)
...
@Obanai.on_message(command("addblacklist") & restrict_filter)
...
@Obanai.on_callback_query(filters.regex("^rm_allblacklist$"))
