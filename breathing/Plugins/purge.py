...
@Obanai.on_message(command("purge") & admin_filter)

async def purge(c: Obanai, m: Message):
...
@Obanai.on_message(command("spurge") & admin_filter)

async def spurge(c: Obanai, m: Message):
...
async def del_msg(c: Obanai, m: Message):
