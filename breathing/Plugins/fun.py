...
@Obanai.on_message(command("shout"))
...
@Obanai.on_message(command("runs"))
...
@Obanai.on_message(command("slap"))

async def fun_slap(c: Obanai, m: Message):
...
@Obanai.on_message(command("roll"))
...
@Obanai.on_message(command("toss"))
...
@Obanai.on_message(command("insult"))

async def insult(c: Obanai, m: Message):
...
@Obanai.on_message(command("yes"))

async def yesw(c: Obanai, m: Message):
...
@Obanai.on_message(command("no"))

async def now(c: Obanai, m: Message):
...
@Obanai.on_message(command("shrug"))
...
@Obanai.on_message(command("bluetext"))
...
@Obanai.on_message(command("decide"))
...
@Obanai.on_message(command("react"))
...
@Obanai.on_message(command("weebify"))
