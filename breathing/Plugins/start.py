...
You can donate by contacting my owner: [Ice Douma](http://t.me/Kokushibotoken)
...
@Obanai.on_callback_query(filters.regex("^close_admin$"))
...
async def start(c: Obanai, m: Message):
...
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! I am the serpent Hashira ⚕️.

I'm here to help you manage your groups!

Hit /help to find out more about how to use me in my full potential!

Join my [News Channel](https://t.me/TheUnityNetwork) to get information on all the latest updates."""
...
@Obanai.on_callback_query(filters.regex("^start_back$"))
...
Hey [{q.from_user.first_name}](http://t.me/{q.from_user.username})! I am the serpent hashira ⚕️.
...
@Obanai.on_callback_query(filters.regex("^commands$"))
...
@Obanai.on_message(command("help"))
...
@Obanai.on_callback_query(filters.regex("^plugins."))

async def get_module_info(c: Obanai,q: CallbackQuery):
