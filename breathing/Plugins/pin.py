...
@Obanai.on_message(command("pin") & admin_filter)
...
@Obanai.on_message(command("unpin") & admin_filter)

async def unpin_message(c: Obanai, m: Message):
...
@Obanai.on_message(command("unpinall") & admin_filter)
...
@Obanai.on_callback_query(regex("^unpin_all_in_this_chat$"))

async def unpinall_calllback(c: Obanai, q: CallbackQuery):
...
@Obanai.on_message(command("antichannelpin") & admin_filter)
...
@Obanai.on_message(command("pinned") & admin_filter)

async def pinned_message(c: Obanai, m: Message):
...
@Obanai.on_message(command("cleanlinked") & admin_filter)
...
@Obanai.on_message(command("permapin") & admin_filter)
