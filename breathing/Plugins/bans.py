...
@Obanai.on_message(command("tban") & restrict_filter)

async def tban_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("stban") & restrict_filter)

async def stban_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("dtban") & restrict_filter)

async def dtban_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("kick") & restrict_filter)

async def kick_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("skick") & restrict_filter)

async def skick_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("dkick") & restrict_filter)

async def dkick_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("unban") & restrict_filter)

async def unban_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("sban") & restrict_filter)

async def sban_usr(c: Obanai, m: Message):
...
@Obanai.on_message(command("dban") & restrict_filter)

async def dban_usr(c: Obanai, m: Message):
