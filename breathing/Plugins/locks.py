...
anti_c_send = [-1001958459072]

anti_forward = [-1001958459072]

anti_forward_u = []

anti_forward_c = []

@Obanai.on_message(command("locktypes"))
...
@Obanai.on_message(command("lock") & restrict_filter)

async def lock_perm(c: Obanai, m: Message):
...
@Obanai.on_message(command("locks") & restrict_filter)
...
@Obanai.on_message(command("unlock") & restrict_filter)

async def unlock_perm(c: Obanai, m: Message):
...
async def is_approved_user(c:Obanai, m: Message):
...
@Obanai.on_message(filters.all & ~filters.me,18)

async def lock_del_mess(c:Obanai, m: Message):
