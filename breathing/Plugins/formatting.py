...
@Obanai.on_callback_query(filters.regex("^formatting."))

async def get_formatting_info(c: Obanai, q: CallbackQuery):
...
Use this to make Obanai feel a bit more customised! (only works in filters/notes)
...
@Obanai.on_callback_query(filters.regex("^back."))
...
Obanai supports a large number of formatting options to make your messages more expressive. Take a look by clicking the buttons below!""",
