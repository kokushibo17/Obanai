...
@Obanai.on_message(command("report") & filters.group)

async def report_watcher(c: Obanai, m: Message):
...
@Obanai.on_callback_query(filters.regex("^report_"))

async def report_buttons(c: Obanai, q: CallbackQuery):
