...
async def warn(c: Obanai, m: Message):
...
@Obanai.on_message(command("resetwarns") & restrict_filter)

async def reset_warn(c: Obanai, m: Message):
...
@Obanai.on_message(command("warns") & filters.group)

async def list_warns(c: Obanai, m: Message):
...
@Obanai.on_callback_query(filters.regex("^warn."))

async def remove_last_warn_btn(c: Obanai, q: CallbackQuery):
...
@Obanai.on_message(command(["warnings", "warnsettings"]) & admin_filter)
...
@Obanai.on_message(command("warnlimit") & admin_filter)
