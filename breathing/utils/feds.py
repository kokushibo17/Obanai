...
import EnmuBot.modules.sql.feds_sql as sql
from EnmuBot import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
...
from Messi.modules.helper_funcs.string_handling import markdown_parser
...
def __stats__():
    ...
    return "𒊹 {} banned users across {} Federations".format(
        len(all_fbanned),
        len(all_feds),
    )
