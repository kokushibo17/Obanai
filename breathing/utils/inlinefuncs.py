...
from Messi.services.keyboard import Ikb
from Messi.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from Messi.services.tasks import _get_tasks_text, all_tasks, rm_task
from Messi.services.types import InlineQueryResultCachedDocument
from Messi.modules.info import get_chat_info, get_user_info
from Messi.modules.music import download_youtube_audio
from Messi.utils.functions import test_speedtest
from Messi.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org//file/0ab524ef81dec1e1c5f59.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/messi_robot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Messi Robot ❤️](https://t.me/Messi_Probot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [SUPPORT](t.me/messi_probot_support)
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
