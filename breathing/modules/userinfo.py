...
from Messi.__main__ import STATS, TOKEN, USER_INFO
from Messi.modules.sql import SESSION
import Messi.modules.sql.userinfo_sql as sql
from Messi.modules.disable import DisableAbleCommandHandler
from Messi.modules.sql.global_bans_sql import is_user_gbanned
from Messi.modules.sql.afk_sql import is_afk, set_afk
from Messi.modules.sql.users_sql import get_user_num_chats
from Messi.modules.helper_funcs.chat_status import sudo_plus
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Erm... yeah, I only trust the Hashiras to set my bio.",
            )
            return
