...
import Messi.modules.sql.welcome_sql as sql
from Messi import (
    DEV_USERS,
    OWNER_ID,
    DRAGONS,
...
from Messi.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Messi.modules.helper_funcs.msg_types import get_welcome_type
from Messi.modules.helper_funcs.handlers import MessageHandlerChecker
from Messi.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Messi.modules.log_channel import gloggable, loggable
from Messi.modules.sql.global_bans_sql import is_user_gbanned
...
def new_member(update: Update, context: CallbackContext):  # sourcery no-metrics
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == 2005266280:
                update.effective_message.reply_photo(
                    "https://te.legra.ph/file/cc586ec8c25a40b4f4f69.jpg", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
                    f" The God Of FLAME has Joined the Chat"
                )
                continue
