...
from Messi import pbot as tomori


@tomori.on_message(filters.command("pokisearch"))
async def PokeDex(_, message):
    if len(message.command) != 2:
        await message.reply_text("/pokisearch Pokemon Name")
        return
